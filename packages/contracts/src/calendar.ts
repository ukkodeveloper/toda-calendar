...
const assetUrlSchema = z.string().trim().min(1).max(25_000_000)
...
export const listDayRecordsQuerySchema = z.object({
  month: monthKeySchema,
})

export const listDayRecordsResponseSchema = z.object({
  dayRecords: z.array(dayRecordSchema),
  month: monthKeySchema,
})
...
export type DayRecordSlot = z.infer<typeof dayRecordSlotSchema>
export type DoodleStroke = z.infer<typeof doodleStrokeSchema>
export type GetDayRecordResponse = z.infer<typeof getDayRecordResponseSchema>
export type GetMonthViewResponse = z.infer<typeof getMonthViewResponseSchema>
export type ListCalendarsResponse = z.infer<typeof listCalendarsResponseSchema>
export type ListDayRecordsResponse = z.infer<typeof listDayRecordsResponseSchema>
